...
public class Alimentacion implements Serializable {
    ...
    @EmbeddedId
    protected cu.edu.unah.Proyectov1.model.AlimentacionPK alimentacionPK;
    ...
    public Alimentacion(cu.edu.unah.Proyectov1.model.AlimentacionPK alimentacionPK) {
        this.alimentacionPK = alimentacionPK;
    }

    public Alimentacion(cu.edu.unah.Proyectov1.model.AlimentacionPK alimentacionPK, String nombreAlimentacion) {
        this.alimentacionPK = alimentacionPK;
    ...
    public Alimentacion(int etapaCrianzarazaidRaza, int etapaCrianzarazaespecieanimalidEspecieAnimal, int etapaCrianzarazaespecieanimalgrupoanimalidGrupoAnimal, int etapaCrianzaidEtapaCrianza, int idAlimentacion) {
        this.alimentacionPK = new cu.edu.unah.Proyectov1.model.AlimentacionPK(etapaCrianzarazaidRaza, etapaCrianzarazaespecieanimalidEspecieAnimal, etapaCrianzarazaespecieanimalgrupoanimalidGrupoAnimal, etapaCrianzaidEtapaCrianza, idAlimentacion);
    }

    public cu.edu.unah.Proyectov1.model.AlimentacionPK getAlimentacionPK() {
