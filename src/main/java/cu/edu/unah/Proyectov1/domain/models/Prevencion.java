...
public class Prevencion implements Serializable {
    ...
    @ManyToMany(mappedBy = "prevencionList")
    private List<cu.edu.unah.Proyectov1.model.ConsejosPreventivos> consejosPreventivosList;
    ...
    @XmlTransient
    public List<cu.edu.unah.Proyectov1.model.ConsejosPreventivos> getConsejosPreventivosList() {
