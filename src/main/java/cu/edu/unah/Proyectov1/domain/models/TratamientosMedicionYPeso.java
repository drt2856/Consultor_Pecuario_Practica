...
import cu.edu.unah.Proyectov1.model.MedicionYPeso;
...
public class TratamientosMedicionYPeso implements Serializable {
    ...
    @EmbeddedId
    protected cu.edu.unah.Proyectov1.model.TratamientosMedicionYPesoPK tratamientosMedicionYPesoPK;
    ...
    @ManyToOne(optional = false)
    private cu.edu.unah.Proyectov1.model.Tratamientos tratamientos;

    public TratamientosMedicionYPeso() {
    }

    public TratamientosMedicionYPeso(cu.edu.unah.Proyectov1.model.TratamientosMedicionYPesoPK tratamientosMedicionYPesoPK) {
        this.tratamientosMedicionYPesoPK = tratamientosMedicionYPesoPK;
    }

    public TratamientosMedicionYPeso(cu.edu.unah.Proyectov1.model.TratamientosMedicionYPesoPK tratamientosMedicionYPesoPK, float dosis) {
        this.tratamientosMedicionYPesoPK = tratamientosMedicionYPesoPK;
        this.dosis = dosis;
    }
    ...
    public TratamientosMedicionYPeso(int tratamientosidTratamiento, int medicionYPesoidMedicionYPeso, int medicionYPesoetapaCrianzarazaidRaza, int medicionYPesoetapaCrianzarazaespecieanimalidEspecieAnimal, int medicionYPesoetapaCrianzarazaespecieanimalgrupoanimalidGrup, int medicionYPesoetapaCrianzaidEtapaCrianza) {
        this.tratamientosMedicionYPesoPK = new cu.edu.unah.Proyectov1.model.TratamientosMedicionYPesoPK(tratamientosidTratamiento, medicionYPesoidMedicionYPeso, medicionYPesoetapaCrianzarazaidRaza, medicionYPesoetapaCrianzarazaespecieanimalidEspecieAnimal, medicionYPesoetapaCrianzarazaespecieanimalgrupoanimalidGrup, medicionYPesoetapaCrianzaidEtapaCrianza);
    }

    public cu.edu.unah.Proyectov1.model.TratamientosMedicionYPesoPK getTratamientosMedicionYPesoPK() {
    ...
    public cu.edu.unah.Proyectov1.model.Tratamientos getTratamientos() {
        return tratamientos;
    }
