...
public class AuthoritiesPK implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof cu.edu.unah.Proyectov1.Authorities.domain.AuthoritiesPK)) {
            return false;
        }
        cu.edu.unah.Proyectov1.Authorities.domain.AuthoritiesPK other = (cu.edu.unah.Proyectov1.Authorities.domain.AuthoritiesPK) object;
