...
public class Authorities implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof cu.edu.unah.Proyectov1.Authorities.domain.Authorities)) {
            return false;
        }
        cu.edu.unah.Proyectov1.Authorities.domain.Authorities other = (cu.edu.unah.Proyectov1.Authorities.domain.Authorities) object;
